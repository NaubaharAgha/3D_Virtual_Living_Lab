...
<head>
    <title>Plan4Act </title>
</head>
<body>
 <ul >
 <IMG SRC="http://www.lst.tfo.upm.es/wp-content/uploads/2014/07/cropped-cropped-LST_Wordpress_bannerCEI2.png" WIDTH=1100 HEIGHT=140>
 </ul>
 <ul >
 Select the action:
 </ul>
 <FORM METHOD="POST">
  <table ALIGN=CENTER>
    <tr>
       <td>
             <INPUT TYPE="image" name="boton" value=doorHomeCloseSS  SRC="https://fotos.subefotos.com/3f8b6a07b94c90d08e7289481803b7f0o.jpg" width="300" height="250"> 
       </td>         

	   <td>

             <INPUT TYPE="image"  name="boton" value=doorHomeOpenSS SRC="https://fotos.subefotos.com/2749f6740ab99223f279fe40ea84ebb7o.jpg" width="300" height="250">
       </td>
          

       <td>
             <INPUT TYPE="image" name="boton" value=doorSalonOpenSS SRC="https://fotos.subefotos.com/ef4911c8299ad6a6b13427be1c1de0aco.jpg" width="300" height="250" > 
       </td>
    </tr> 
    
    <tr>
       <td>
             <INPUT TYPE="image" name="boton" value=doorSalonCloseSS SRC="https://fotos.subefotos.com/1b215560ca80a6df9bc7e4fb4375eafao.jpg" width="300" height="250" > 
       </td>

       <td>
             <INPUT TYPE="image" name="boton" value=SalaLightOpenSS SRC="https://fotos.subefotos.com/f62ded591fb7f969312b3072c2e143c5o.jpg" width="300" height="250"> 
       </td>      

       <td> 
             <INPUT TYPE="image" name="boton" value=SalaLightCloseSS SRC="https://fotos.subefotos.com/83f9209f2257c71cf8bb6a1a7521660bo.jpg" width="300" height="250" > 
       </td>
   </tr>
   </table>          
 </FORM>
    ...
    def handle_request(self,request):
        ...
        if request.command=="POST":    
             ...
             if request.form_event:
              ...
              print "LALALA", request.form_event
              boton = cgi.escape(request.form_event.boton,True)
              if boton=="doorHomeOpenSS":
               print "doorHomeOpenSS"
               doorHomeOpen()
              if boton=="doorHomeCloseSS":
               print "doorHomeCloseSS"
               doorHomeClose()
              if boton=="doorSalonOpenSS":
               print "doorSalonOpenSS"
               doorSalonOpen()
              if boton=="doorSalonCloseSS":
               print "doorSalonCloseSS"
               doorSalonClose()
              if boton=="SalaLightOpenSS":
               print "SalaLightOpenSS"
               Sala_lightONOFFOpen()
              if boton=="SalaLightCloseSS":
               print "SalaLightCloseSS"
               Sala_lightONOFFClose()
             else:
              boton = ''
             request.send_html_code(code)
vizhtml.registerHandlerClass('custom_handler',ExampleRequestHandler)
